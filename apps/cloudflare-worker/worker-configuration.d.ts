/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4215c2f432128cbbc611dc9985f8491)
// Runtime types generated with workerd@1.20260210.0 2025-10-04 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		TURBO_TEAM: string;
		TURBO_TOKEN: string;
		CLOUDFLARE_BACKEND: string;
		CORS_ORIGIN: string;
		CNAM_FORMATION_CODE: string;
		CNAM_BEDEO_URL: string;
		CNAM_BEDEO_CURSUS_PATH: string;
		CNAM_BEDEO_UNITE_VIEW_PATH: string;
		SCRAPER_CACHE_OVERRIDE: string;
		SCRAPER_CACHE_TTL: string;
		SCRAPPER_LEVEL_2_CHECKPOINT: string;
		DOMAIN_NAME: string;
		CLOUDFLARE_API_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_WORKER_MAX_BROWSER_INSTANCES: string;
		ARTIFACT_ENCRYPTION_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CRYPTOKEN" | "PROJECT_ROOT" | "BACKUP_GPG" | "BACKUP_SSH" | "TURBO_TEAM" | "TURBO_TOKEN" | "CLOUDFLARE_BACKEND" | "CORS_ORIGIN" | "CNAM_FORMATION_CODE" | "CNAM_BEDEO_URL" | "CNAM_BEDEO_CURSUS_PATH" | "CNAM_BEDEO_UNITE_VIEW_PATH" | "SCRAPER_CACHE_OVERRIDE" | "SCRAPER_CACHE_TTL" | "SCRAPPER_LEVEL_2_CHECKPOINT" | "DOMAIN_NAME" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_WORKER_MAX_BROWSER_INSTANCES" | "ARTIFACT_ENCRYPTION_KEY">> {}
}
